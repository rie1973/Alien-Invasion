...
class AlienInvasion: 
    def __init__(self):
        #initliaze game, create game resources
        pygame.init()
        ...
        #instance to store game stats ad create scoreboard
    ...
    def _update_bullets(self):
        ...
        #getting rid of disappearing bullet (so they don't take up memory)
    ...
    def _update_aliens(self):
        #check if fleet on edge of screen, update positions of aliens in fleet
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            #remove ships form total number allowed after being hit
            self.stats.ships_left -= 1

            #remove remaining alliens/bullets
            self.aliens.empty()
            self.bullets.empty()

            #create new alien fleet, center ship
            self._create_fleet()
            self.ship.center_ship()
    ...
    def _create_fleet(self):
        ...
        #create alien, find number of aliens in row
        alien = Alien(self)
    ...
    def _change_fleet_direction(self):
        #drop down entire fleet, change fleet direction
        for alien in self.aliens.sprites():
